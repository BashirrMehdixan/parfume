...
@section('content')
					...
					@if ($slides->count() > 0)
						@foreach ($slides as $slide)
							<li class="glide__slide">
								<div class="banner_block" style="background-image: url('{{ asset('storage/' . $slide->image) }}')">
									<div class="container">
										<div class="flex_item">
											<div class="w_lg_66 w-full">
												...
												@if ($slide->title && $slide->description)
													<a href="{{ route('products_category' . session('locale')) }}" class="btn btn_main">
														Shop now
													</a>
												@endif
											</div>
	...
	<section class="about_section section_padding">
		<div class="about_box">
			...
			<div class="container">
				<div class="flex_item">
					<div class="w_full w_lg_66 text_center mx-auto">
					...
					<ul class="glide__slides">
						@if ($bestSell->count() > 0)
							@foreach ($bestSell as $product)
								<li class="glide__slide">
									<x-product-card :url="route('products_category_' . session('locale'), [
									    'slug' => $product->slug,
									    'category' => $product->collection->slug,
									])" :product="$product" />
								</li>
							@endforeach
						@endif
